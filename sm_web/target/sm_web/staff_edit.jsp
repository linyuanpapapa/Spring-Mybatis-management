                ...
                <div class="xjhy">
                    ...
                    <ul class="hypz gjpz clearfix">
                            ...
                            <div class="li_r">
                                <select  name="did">
                                    <c:forEach items="${DList}" var="dep">
                                        ...
                                        <option value="${dep.id}" onselect="true">${dep.name}</option>
                                        </c:if>
                                        <c:if test="${OBJ.did!=dep.id}">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="birthday" type="text" value="<fmt:formatDate value="${OBJ.birthday}" pattern="yyyy-MM-dd"></fmt:formatDate>">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
